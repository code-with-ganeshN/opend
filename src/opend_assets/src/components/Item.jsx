...
function Item(props) {
  ...
  // while deploying i have to remove this line beacuse it working on local development but in ICP live network it doesn't works
  agent.fetchRootKey();
  let NFTActor;
  ...
  async function sellItem() {
    ...
    console.log("listing items : "+listingResult);
